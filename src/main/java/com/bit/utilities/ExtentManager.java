...
//public class ExtentManager {
    ...
    private static String macPath = System.getProperty("user.dir")+ "/target/screenshots";
    private static String windowsPath = System.getProperty("user.dir")+ "/target/screenshots";
    private static String macReportFileLoc = macPath + "/" + reportFileName;
    private static String winReportFileLoc = windowsPath + "/" + reportFileName;

    private static String linuxPath = System.getProperty("user.dir")+ "/target/screenshots";
